...
\echo
\echo '============================================================'
\echo 'AeroTrace Trace List Baseline - Duration Filter'
\echo '============================================================'
...
\echo 'Limit:   50'
\echo 'Filter:  minSpanDurationNano=250000000'
...
PREPARE trace_list_duration_filter (
    UUID,
    UUID,
    TIMESTAMPTZ,
    TIMESTAMPTZ,
...
EXPLAIN (
    ...
    EXECUTE trace_list_duration_filter(
        '77777777-7777-7777-7777-777777777777'::UUID,
        '88888888-8888-8888-8888-888888888888'::UUID,
        '2026-08-02 12:00:00+00'::TIMESTAMPTZ,
        '2026-08-03 05:00:00+00'::TIMESTAMPTZ,
...
DEALLOCATE trace_list_duration_filter;

\echo
\echo '============================================================'
\echo 'Duration-filter baseline completed'
\echo '============================================================'