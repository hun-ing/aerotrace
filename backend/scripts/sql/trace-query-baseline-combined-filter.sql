...
\echo
\echo '============================================================'
\echo 'AeroTrace Trace List Baseline - Combined Filters'
\echo '============================================================'
...
\echo 'Error:   true'
\echo 'Minimum span duration: 250000000 ns'
...
WHERE contains_service
  AND contains_error
  AND longest_span_duration_nano >= 250000000;
...
\echo
\echo '============================================================'
\echo 'Combined-filter baseline completed'
\echo '============================================================'